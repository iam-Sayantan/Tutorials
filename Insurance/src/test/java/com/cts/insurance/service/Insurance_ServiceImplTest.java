...
class Insurance_ServiceImplTest {
	...
	public void getInsuranceByCId() {
		...
		Insurance ins = service.findInsuranceByCId("cus987");
		assertEquals(insurance, ins);
	}
	...
	public void getInsuranceByIId() {
		...
		Insurance ins = service.findInsuranceByIId("1234567891234");
		assertEquals(insurance, ins);
	}
	...
	public void getInsuranceByIIdAndCId() {
		Insurance insurance = new Insurance("cus702", "INSNewName", "medical");
		service.addInsurances(insurance);
		insurance.setInsurance_id("1234567894321");
		Insurance ins = service.findInsuranceByIIdandCId("1234567894321", "cus702");
		assertEquals(insurance, ins);
	}
	...
	public void getInsuranceByIIdDifferentAndCId() {
		Insurance insurance = new Insurance("cus777", "INSNoName", "corona");
		service.addInsurances(insurance);
		insurance.setInsurance_id("1237567894321");
		Insurance ins = service.findInsuranceByIIdandCId("1239567894321", "cus777");
